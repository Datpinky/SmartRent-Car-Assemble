...
export const mapProfileUser = (user = {}) => ({
  ...
  phone: user.phone || '',
  address: user.userLocation?.address || user.address || user.showroom_address || '',
  age: user.age ?? '',
  showroom_status: user.showroom_status || '',
  business_name: user.business_name || '',
  showroom_address: user.showroom_address || '',
  public_address: user.public_address || user.showroom_address || user.address || '',
  ...
  logo_url: user.logo_url || user.logo || '',
