...
const InfoTab = ({ form, setForm }) => (
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
    ...
    <div style={{ gridColumn: 'span 2' }}>
      <label htmlFor="sp-address" style={{ fontSize: '0.82rem', fontWeight: 600, color: '#374151', display: 'block', marginBottom: 5 }}>Địa chỉ công khai</label>
      <input id="sp-address" value={form.public_address} onChange={(e) => setForm((f) => ({ ...f, public_address: e.target.value }))}
        className="focus:outline-none focus-visible:ring-2 focus-visible:ring-primary" style={inputStyle} />
    </div>
    <div style={{ gridColumn: 'span 2' }}>
